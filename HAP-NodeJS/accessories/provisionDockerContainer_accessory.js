...
//OO parameters
var centralUrl = "<centralUrl>";
var flowUuid = "accbe714-c287-4373-91da-6a32f988befe";
var runName = "Request Docker Container Provisioning";
...
var ooFlow = exports.accessory = new Accessory('ProvisionDockerContainer', ooFlowUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
ooFlow.username = "00:00:00:00:00:01";
...
ooFlow
  .addService(Service.Lightbulb, "ProvisionDockerContainer") // services exposed to the user should have "names" like "Restart VM Flow" for us
