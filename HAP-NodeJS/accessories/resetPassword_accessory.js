...
var ooFlow = exports.accessory = new Accessory('ResetPassword', ooFlowUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
ooFlow.username = "1D:2B:3C:4D:5E:F1";
...
ooFlow
  .addService(Service.Lightbulb, "ResetPassword") // services exposed to the user should have "names" like "Restart VM Flow" for us
