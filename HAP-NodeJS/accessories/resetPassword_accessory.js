...
var flowUuid = "1b6596e2-2517-44d4-a406-af25205cc914";
var runName = "Reset testuser password";
var authToken = "YWRtaW46QWRtaW4=";
var inputs ="\"useRandomPassword\": \"True\"";
...
var ooFlow = exports.accessory = new Accessory('ResetPasswordFlow', ooFlowUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
ooFlow.username = "1A:2B:3C:4D:5E:F3";
...
ooFlow
  .addService(Service.Lightbulb, "Reset Password Flow") // services exposed to the user should have "names" like "Restart VM Flow" for us
