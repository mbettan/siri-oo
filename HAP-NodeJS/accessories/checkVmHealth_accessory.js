...
var runName = "Check Linux VM Health";
...
var ooFlow = exports.accessory = new Accessory('Check VM Health Flow', ooFlowUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
ooFlow.username = "1A:2B:3C:4D:5E:F4";
...
ooFlow
  .addService(Service.Lightbulb, "Check VM Health Flow") // services exposed to the user should have "names" like "Restart VM Flow" for us
