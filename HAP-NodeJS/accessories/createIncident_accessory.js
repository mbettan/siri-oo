...
ooFlow.username = "1A:2B:3C:4D:5E:F1";
...
ooFlow
  .addService(Service.Lightbulb, "CreateIncidentFlow") // services exposed to the user should have "names" like "Restart VM Flow" for us
