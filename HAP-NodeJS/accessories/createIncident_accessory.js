...
var flowUuid = "b1f373fc-0038-41b1-9d91-21b54f01c259";
var runName = "Create Incident VM does not respond";
...
var ooFlow = exports.accessory = new Accessory('CreateIncidentFlow', ooFlowUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
ooFlow.username = "1A:2B:3C:4D:5E:F2";
...
ooFlow
  .addService(Service.Lightbulb, "Create Incident Flow") // services exposed to the user should have "names" like "Restart VM Flow" for us
